...
class ReportController extends Controller
{
    ...
    {        
        ...
        $overview2=DB::select(DB::raw("select users.name,m.id,m.nama ,close_price, m2.created_at, final_commission from users join mlistings m on users.id = m.user_id join mtransactions m2 on m.id = m2.mlisting_id where month(m2.created_at) = ".$bulan." and year(m2.created_at) = ".$tahun.";"));
        ...
        return view('report.penjualanagen.index',compact('overview','bulan','tahun','listingview','overview2'));
    }
