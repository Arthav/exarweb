...
@section('title')
Exarweb: Daftar Properti Terjual
@endsection
...
<div class="w3-container w3-blue-gray w3-padding-32">
    ...
    <div class="W3-container">
        ...
        <form action="{{ route('Listing.Sold') }}" method="get">
            <div class="well">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="kamar_tidur" class="form-control">
                                <option value="" {{$kamar_tidur == '' ? 'Selected' : ''}}>Semua</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="kamar_mandi" class="form-control">
                                <option value="" {{$kamar_mandi == '' ? 'Selected' : ''}}>Semua</option>
