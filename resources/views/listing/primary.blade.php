...
<!-- FILTER CARI -->
<br><br><br>
<div class="w3-container w3-deep-purple w3-padding-32">
    <!--Awal bagian container-->
    <div class="W3-container">
        <form action="{{ route('Listing.Primary') }}" method="get">
            <div class="well">
        ...
        <div class="grid-12">
            <div class="agenproperti-thumb">
                <div class="agenproperti-gambar"><div class="ribbon best"><span>{{$list->sold == '0' ? 'Ready' : 'Sold'}}</span></div>
