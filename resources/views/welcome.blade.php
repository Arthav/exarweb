        ...
        <div class="super_container">
                        ...
                        <div class="col">
                            <div class="home_search_container">
                                <div class="home_search_content">
                                    <form action="{{ route('index') }}" method="GET" class="search_form d-flex flex-row align-items-start justfy-content-start">
            ...
            <div class="cities">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="section_title">Properti terbaik di kota anda</div>
                            <div class="section_subtitle">Carilah properti idaman anda</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="city">
                        ...
                        <div class="city_overlay">
                            <a href="#" class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="city_subtitle">Cicilan mulai dari Rp 12.000.000/bulan</div>
                            </a>	
                        </div>
                    </div>
                    ...
                    <div class="city">
                        ...
                        <div class="city_overlay">
                            <a href="#" class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="city_subtitle">Cicilan mulai dari Rp 15.000.000/bulan</div>
                            </a>	
                        </div>
                    </div>
                    ...
                    <div class="city">
                        ...
                        <div class="city_overlay">
                            <a href="#" class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="city_subtitle">Cicilan mulai dari Rp 8.000.000/bulan</div>
                            </a>	
                        </div>
                    </div>
                    ...
                    <div class="city">
                        ...
                        <div class="city_overlay">
                            <a href="#" class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="city_subtitle">Cicilan mulai dari Rp 25.000.000/bulan</div>
                            </a>	
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row testimonials_row">
                        ...
                        <div class="col-lg-4 testimonial_col">
                            <div class="testimonial">
                                <div class="testimonial_title">Luar biasa</div>
                                <div class="testimonial_text">Bukan hanya properti baik yang saya dapatkan, namun pelayanan yang sangat baik dari pihak exari.</div>
                                <br><br>
                                <div class="testimonial_author_image"><img src="{{ asset('bluesky/images/testimonial_1.jpg') }}" alt=""></div>
                                <div class="testimonial_author"><a href="#">Dian Suma</a><span>, Klien</span></div>
                        ...
                        <div class="col-lg-4 testimonial_col">
                            <div class="testimonial">
                                <div class="testimonial_title">Sangat bersahabat</div>
                                <div class="testimonial_text">Saya memiliki ekspektasi yang tinggi saat membeli rumah sehingga rewel sekali, respon yang diberikan oleh marketing exari sangatlah bersahabat, sehingga saya menemukan rumah idaman saya.</div>
                                <div class="testimonial_author_image"><img src="{{ asset('bluesky/images/testimonial_2.jpg') }}" alt=""></div>
                                <div class="testimonial_author"><a href="#">Michael Kevin</a><span>, Klien</span></div>
                                <div class="rating_r rating_r_5 testimonial_rating"><i></i><i></i><i></i><i></i><i></i></div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 testimonial_col">
                            <div class="testimonial">
                                <div class="testimonial_title">Sangat mudah</div>
                                <div class="testimonial_text">Menggunakan layanan exari sangatlah mudah, tidak dibikin ribet sama sekali.</div>
                                <br><br><br>
                                <div class="testimonial_author_image"><img src="{{ asset('bluesky/images/testimonial_3.jpg') }}" alt=""></div>
                                <div class="testimonial_author"><a href="#">Charles Tomas</a><span>, Klien</span></div>
                                <div class="rating_r rating_r_5 testimonial_rating"><i></i><i></i><i></i><i></i><i></i></div>
                            </div>
                        </div>
